    ...
    return (
        <div className="reader">
            ...
            <div className="readerDetails">
                <div className="readerName capitalize">{reader.firstname} {reader.lastname}</div>
                <div className="readerBooks">4 Books</div>
            </div>
            { reader._id === receiverId ? <span>Request sent.</span> : <button onClick={() => add(reader._id)} title="Send Friend Request">&#43;</button>}
        </div>
    );
}